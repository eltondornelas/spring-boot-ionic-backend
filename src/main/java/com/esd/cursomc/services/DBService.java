...
import com.esd.cursomc.domain.Endereco;
...
import com.esd.cursomc.domain.PagamentoComCartao;
...
import com.esd.cursomc.repositories.CidadeRepository;
import com.esd.cursomc.repositories.ClienteRepository;
import com.esd.cursomc.repositories.EnderecoRepository;
import com.esd.cursomc.repositories.EstadoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {		
		...
		//primeiro salva o estado, pois ele tem várias cidades ou até nenhuma
		
		estadoRepository.saveAll(Arrays.asList(est1, est2));
		cidadeRepository.saveAll(Arrays.asList(c1, c2, c3));
		
		Cliente cli1 = new Cliente(null, "Maria Silva", "eltondornelas@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "eltondornelas@outlook.com", "95806943038", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("983633233", "23838393"));
